...
description: |
  ...
  그런데 지금까지 왜 못했냐? 소마 연수생으로 선정되기 위해서는 코딩 테스트와 면접 등등을 거쳐야 하기 때문이다. 코딩 테스트라 함은 알고리즘인데 나는 알고리즘에 그닥 자신이 없다. 그...
date: 2022-03-08
updated: 2025-11-10
status:
  - published
...
series: "대외활동"
reading_time: 5
cover_image: "../images/posts/sw-maestro-13/cover.png"
---
## 👀 왜 했나요

![cover6.jpg](../images/posts/sw-maestro-13/image-1.jpg)
고등학교 때 종종 들어서 소프트웨어 마에스트로(이하 소마)의 명성은 익히 알고 있었다. 전국의 코딩 고인물들이 모여서 프로젝트도 진행하고 네트워크도 쌓는 부트캠프 느낌의 프로그램이라고 알고 있는데, 언젠가 한번 도전해보고 싶은 활동 중 하나였다.
...
![image.png](../images/posts/sw-maestro-13/image-2.png)
...
![image.png](../images/posts/sw-maestro-13/image-3.png)
...
![스크린샷 2022-03-05 오후 5.39.55.png](../images/posts/sw-maestro-13/image-4.png)
...
![image.png](../images/posts/sw-maestro-13/image-5.png)

### 2차 코딩테스트

![image.png](../images/posts/sw-maestro-13/image-6.png)
...
![스크린샷 2022-03-19 오후 4.00.42.png](../images/posts/sw-maestro-13/image-7.png)
...
### 심층 면접
![image.png](../images/posts/sw-maestro-13/image-8.png)
...
![20220329_121046.jpg](../images/posts/sw-maestro-13/image-9.jpg)
...
![image.png](../images/posts/sw-maestro-13/image-10.png)
