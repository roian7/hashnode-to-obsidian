...
subtitle: "feat. 국룰 투두리스트 만들기"
slug: "jetpack-compose"
description: |
  Jetpack Compose를 이용해 간단한 To-do 앱을 만들며 느낀 점과 장단점에 대해 다룹니다.
  👀 너 누군데
  고3 입시를 준비하느라 안드로이드 개발을 1년 정도 쉬었다. 그동안 있었던 굵직한 변화들을 살펴보니, 최근 혜성같이 등장한 Jetpack Compose가 엄청 유행이라고 한다. 대체 컴포즈가 뭐고, 얼마나 대단하길래 xml을 대체한다는 얘기까지 나오는걸까?
  
  원래 안드로이드 개발에서는 앱의 레이아웃(UI)을 표현하기 위해 xm...
date: 2021-11-28
updated: 2025-11-10
status:
  - published
...
series: "개발"
reading_time: 5
cover_image: "../images/posts/jetpack-compose/cover.png"
---
Jetpack Compose를 이용해 간단한 To-do 앱을 만들며 느낀 점과 장단점에 대해 다룹니다.
...
![image.png](../images/posts/jetpack-compose/image-1.png)
...
![image.png](../images/posts/jetpack-compose/image-2.png)

![image.png](../images/posts/jetpack-compose/image-3.png)
...
![30fviu.jpg](../images/posts/jetpack-compose/image-4.jpeg)
...
![image.png](../images/posts/jetpack-compose/image-5.png)
...
![Screen_Recording_20211128-174326_TODO_1.gif](../images/posts/jetpack-compose/image-6.gif)
